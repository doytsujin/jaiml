...
public class CharacterClasses {
  ...
  public static boolean isS(char ch) {
    //(#x20 | #x9 | #xD | #xA)
    switch (ch) {
      case '\u0020':
      case '\u0009':
  ...
  public static boolean isLetter(char ch) {
    ...
    return CharacterClasses.isBaseChar(ch) || CharacterClasses.isIdeographic(ch);
  }
  public static boolean isNameChar(char ch) {
    //[4]   	NameChar	   ::=   	Letter | Digit | '.' | '-' | '_' | ':' | CombiningChar | Extender
    return (CharacterClasses.isLetter(ch) || CharacterClasses.isDigit(ch) || ch=='.' || ch=='-' || ch=='_' || ch==':' || CharacterClasses.isCombiningChar(ch) || CharacterClasses.isExtender(ch));
  }

  public static boolean isNameFirst(char ch) {
   //[5]   	Name	   ::=   	(Letter | '_' | ':') (NameChar)*
   return (CharacterClasses.isLetter(ch) || ch=='_' || ch==':');
  }
