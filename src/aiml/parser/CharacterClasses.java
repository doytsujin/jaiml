...
public class CharacterClasses {
  ...
  public static boolean isLetter(char ch) {
    ...
    return CharacterClasses.isBaseChar(ch) ||
        CharacterClasses.isIdeographic(ch);
  }

  public static boolean isNameChar(char ch) {
    //[4]   	NameChar	   ::=   	Letter | Digit | '.' | '-' | '_' | ':' | CombiningChar | Extender
    return (CharacterClasses.isLetter(ch) || CharacterClasses.isDigit(ch) ||
        ch == '.' || ch == '-' || ch == '_' || ch == ':' ||
        CharacterClasses.isCombiningChar(ch) || CharacterClasses.isExtender(ch));
  }
