...
/**
 * <p>The ContextInfo class maintains information about all the different
 * contexts and provides methods to query the value of context variables.
 * ContextInfo is meant to serve as an interface between the different types of
 * contextual data sources, for example a database, system scripts and the
 * matching algorithm.</p>
 *
 * <p><i>Note to self: </i>
 * I'm thinking about how to ensure the general availability of this class and
 * it's methods, I'll probably use a singleton, static methods
...
public class ContextInfo {
   ...
   * ContextInfo objects. It is possible that future implementations will use
  ...
  /**
   * Get information about a context
   * @param context the order of the context
   * @return information about a context
   */
   ...
   * be present before matching can occur, otherwise a NoContextsPresentException
   * is thrown.
