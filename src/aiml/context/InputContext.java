/*
    ...
    Copyright (C) 2004-2006  Kim Sullivan
...
/**
 * <p>A special context type, needed for functionality of the standard 'input'
 * context. To allow recursive calls to the classifier, this context must be
 * implemented as a stack of values.</p>
 * <p>A context with the name 'input' must always be present in the system, and it
 * must be an implementation of InputContext</p>
 * @author Kim Sullivan
 * @version 1.0
 */
